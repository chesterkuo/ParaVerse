      ...
      <div className="flex-1 flex items-center justify-center bg-bg px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-center text-text-secondary mt-6">
            ...
            <Link to="/register" className="text-violet font-medium hover:text-violet-light transition-colors">Create account</Link>
          </p>
        </div>
      </div>
    </div>
